...
import nightware.main.module.impl.render.JumpCircle;
...
public abstract class EntityLivingBase extends Entity
{
     ...
     */
    protected void jump() {
        if (this instanceof EntityPlayerSP && NightWare.getInstance().getModuleManager().getModule(JumpCircle.class).isEnabled()) {
            JumpCircle.circles.add(new JumpCircle.Circle(Minecraft.getMinecraft().player.posX, Minecraft.getMinecraft().player.posY + 0.1D, Minecraft.getMinecraft().player.posZ));
        }
    ...
    public boolean isActiveItemStackBlocking(int JetoLooser)
    {
        if (this.isHandActive() && !this.activeItemStack.func_190926_b())
        {
            Item item = this.activeItemStack.getItem();
            ...
            {
                return item.getMaxItemUseDuration(this.activeItemStack) - this.activeItemStackUseCount >= JetoLooser;
            }
        }
        else
        {
