   ...
   public void drawTextBox() {
      if (this.getVisible()) {
         if (this.getEnableBackgroundDrawing()) {
            ...
            RenderUtility.drawRoundedRect((float)this.xPosition, (float)this.yPosition, (float)this.width, (float)this.height, 6.0F, isDark ? (new Color(38, 38, 38)).getRGB() : (new Color(214, 214, 214)).getRGB());
         }
         ...
         if (!s.isEmpty()) {
            ...
            j1 = (int)this.fontRendererInstance.drawString(s1, (float)l, (float)i1 + 2.0F, i);
         }
         ...
         if (!s.isEmpty() && flag && j < s.length()) {
            int var10000 = (int)this.fontRendererInstance.drawString(s.substring(j), (float)j1, (float)i1 + 2.0F, i);
         }
         ...
         if (flag1) {
            if (flag2) {
               ...
               this.fontRendererInstance.drawString("_", (float)k1 + 1.0F, (float)i1 + 2.0F, i);
            }
         }
