...
public class CsGui extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (search.getText().isEmpty() && !search.isFocused()) {
         Fonts.mntssb16.drawString("Ïîèñê ìîäóëåé", (float)(this.x + 99), (float)(this.y + 11), (new Color(120, 120, 120)).getRGB());
      }
      ...
      Fonts.nunitoBold14.drawString("Ôóíêöèè", this.x + 4, (float)(this.y + 10), guiColors[3].getRGB());
      ...
      for(int var11 = 0; var11 < var10; ++var11) {
         ...
         if (category.equals(Category.CONFIGS)) {
            Fonts.nunitoBold14.drawString("Íàñòðîéêè", this.x + 4, (float)(this.y + 25 + 20 * category.ordinal()), guiColors[3].getRGB());
         }
      ...
      // ÏÅÐÅÍÅÑÒÈ ÞÇÅÐÈÍÔÎ ÍÈÆÅ Â ÍÎÐÌÀËÜÍÓÞ ÏËÀØÊÓ
   ...
   private void drawThemes(int mouseX, int mouseY) {
      ...
      Fonts.nunitoBold18.drawString("Öâåò êëèåíòà", (float)(this.x + 100), this.text1Y, isDark ? Color.WHITE.getRGB() : (new Color(65, 65, 65)).getRGB());
      ...
      Fonts.nunitoBold18.drawString("Âûáîð òåìû", (float)(this.x + 100), this.text2Y, isDark ? Color.WHITE.getRGB() : (new Color(65, 65, 65)).getRGB());
      xOffset = 0;
      offset = this.scrollY;
