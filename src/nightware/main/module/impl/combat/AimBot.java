...
public class AimBot extends Module {
    ...
    public static BooleanSetting renderFov = new BooleanSetting("Отображать радиус", true);
    public static ColorSetting fovColor = new ColorSetting("Цвет радиуса", new Color(255, 255, 255, 255).getRGB());
    public static BooleanSetting renderFirePos = new BooleanSetting("Показ предикта", false);
